...
LDFLAGS	= $(MACHDEP) -O2 -T$(FXCGSDK)/toolchain/prizm.x -Wl,-static -g

#---------------------------------------------------------------------------------
# any extra libraries we wish to link with the project
#---------------------------------------------------------------------------------
SYSTEMLIBS :=  -lfxcg -lm -lc -lgcc
LIBS	:=	-lzx7 -Llibs/calctype -lcalctype -lsnd -lptune2_simple $(SYSTEMLIBS)

libs/calctype/libcalctype.a:
	make -C libs/calctype
